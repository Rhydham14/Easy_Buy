...
const Admin = () => {
  ...
  const handleEditProduct = async () => {
    ...
    try {
      ...
      console.error("An error occurred. Please try again.", error);
      setError("An error occurred while updating the product. Please try again."); // Set error message
    }
  };
  ...
  return (
            ...
            {currentItems.map((product, index) => (
              <Grid key={index} item xs={12} sm={6} md={4} lg={3}>
                <Card>
                  ...
                  <CardContent>
                    <img src={product.images} alt={product.title} style={styles.image} />
                    <Typography variant="body2" color="textSecondary" style={styles.truncatedDescription}>
                      {product.description}
                    </Typography>
    ...
    >
      <Box sx={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', bgcolor: 'background.paper', borderRadius: '8px', boxShadow: 24, p: 4, width: 400 }}>
